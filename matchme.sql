...
-- If the database exists, kick everyone out and drop it so we start fresh
IF EXISTS (SELECT * FROM sys.databases WHERE name = 'TinderHW3')
BEGIN
    ALTER DATABASE TinderHW3 SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
    DROP DATABASE TinderHW3;
END
GO

CREATE DATABASE TinderHW3;
GO
...
(8, 8,  'Hi :) Mostly chill and a bit of indie. You?',             '2023-05-14 13:26:00'),
...
CREATE TABLE superlikes_balance (
    superlike_id INT Identity(1,1) PRIMARY KEY,
    user_id INT NOT NULL,
...
ALTER TABLE users
ADD subscription_type_id INT DEFAULT 1;
GO
...
INSERT INTO [dbo].[swipes] (swiper_id, swiped_id, swipetype, created_at) VALUES 
